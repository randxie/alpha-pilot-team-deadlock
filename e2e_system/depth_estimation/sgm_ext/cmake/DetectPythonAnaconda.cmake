...
if(NOT CMAKE_FIND_ANACONDA_PYTHON_INCLUDED)
  ...
  if(ANACONDA_PYTHON_FOUND)
    ...
    if( env_CONDA_DEFAULT_ENV STREQUAL "root" )
      set(PYTHON_INCLUDE_DIRS "${ANACONDA_PYTHON_DIR}/include/${_py_id}" CACHE INTERNAL "")
      set(PYTHON_LIBRARIES "${ANACONDA_PYTHON_DIR}/lib/lib${_py_id}${CMAKE_SHARED_LIBRARY_SUFFIX}" CACHE INTERNAL "")
    else()
      set(PYTHON_INCLUDE_DIRS "${ANACONDA_PYTHON_DIR}/envs/${env_CONDA_DEFAULT_ENV}/include/${_py_id}" CACHE INTERNAL "")
      set(PYTHON_LIBRARIES "${ANACONDA_PYTHON_DIR}/envs/${env_CONDA_DEFAULT_ENV}/lib/lib${_py_id}${CMAKE_SHARED_LIBRARY_SUFFIX}" CACHE INTERNAL "")
    endif()
