...
_PREPROCESSINGSTEP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_rotate_along_y_axis', full_name='object_detection.protos.PreprocessingStep.random_rotate_along_y_axis', index=28,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_motion_blur', full_name='object_detection.protos.PreprocessingStep.random_motion_blur', index=29,
...
_RANDOMROTATEALONGY = _descriptor.Descriptor(
  name='RandomRotateAlongY',
  full_name='object_detection.protos.RandomRotateAlongY',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_RANDOMBLUR = _descriptor.Descriptor(
  name='RandomBlur',
  full_name='object_detection.protos.RandomBlur',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_PREPROCESSINGSTEP.fields_by_name['random_rotate_along_y_axis'].message_type = _RANDOMROTATEALONGY
_PREPROCESSINGSTEP.fields_by_name['random_motion_blur'].message_type = _RANDOMBLUR
...
_PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step'].fields.append(
  _PREPROCESSINGSTEP.fields_by_name['random_rotate_along_y_axis'])
_PREPROCESSINGSTEP.fields_by_name['random_rotate_along_y_axis'].containing_oneof = _PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step']
_PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step'].fields.append(
  _PREPROCESSINGSTEP.fields_by_name['random_motion_blur'])
_PREPROCESSINGSTEP.fields_by_name['random_motion_blur'].containing_oneof = _PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step']
...
DESCRIPTOR.message_types_by_name['RandomRotateAlongY'] = _RANDOMROTATEALONGY
DESCRIPTOR.message_types_by_name['RandomBlur'] = _RANDOMBLUR
...
RandomRotateAlongY = _reflection.GeneratedProtocolMessageType('RandomRotateAlongY', (_message.Message,), dict(
  DESCRIPTOR = _RANDOMROTATEALONGY,
  __module__ = 'object_detection.protos.preprocessor_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.RandomRotateAlongY)
  ))
_sym_db.RegisterMessage(RandomRotateAlongY)

RandomBlur = _reflection.GeneratedProtocolMessageType('RandomBlur', (_message.Message,), dict(
  DESCRIPTOR = _RANDOMBLUR,
  __module__ = 'object_detection.protos.preprocessor_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.RandomBlur)
  ))
_sym_db.RegisterMessage(RandomBlur)
